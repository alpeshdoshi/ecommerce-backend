...
//Controller Advice annotation is used to handle errors at global level.
// This annotation allows us to use exception handling techniques and apply them across the whole application, not just to an individual controller
@ControllerAdvice
